    ...
    <div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8 ">
        ...
        <div className="space-y-6">
          ...
          <div>
            {Array.isArray(invoice.passengerName) && invoice.passengerName.length > 0 && (
              <div className="space-y-6">
                {invoice.passengerName.map((name, idx) => (
                  <div key={idx} className="relative border border-gray-200 p-4 space-y-2 rounded-md bg-gray-50">
                    <button
                      onClick={() => {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Field label={`Passenger Name`} value={name} readOnly placeholder="eg: Example user" />

                      <Field
                        label="Passport Number"
                        value={invoice.passengers?.[idx]?.passportNumber || ""}
                        required
